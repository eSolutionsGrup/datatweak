...
import ro.esolutions.datatweak.io.sinks.DataFrameSink.{FileDataFrameSink, JdbcDataFrameSink}
import ro.esolutions.datatweak.io.sinks.{FileDataSink, JdbcDataSink}
import ro.esolutions.datatweak.io.sinks.SinkConfiguration.{FileSinkConfiguration, JdbcSinkConfiguration}
